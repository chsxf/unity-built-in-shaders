...
#if defined(SHADER_API_GLES3) || defined(SHADER_API_GLCORE) || defined(SHADER_API_VULKAN) || defined(SHADER_API_SWITCH) || defined(SHADER_API_SWITCH2) || defined(SHADER_API_WEBGPU)
...
// - UNITY_GET_INSTANCE_ID              (Internal) Get the instance ID from input struct.
    ...
    #if (!defined(SHADER_API_GLES3) && !defined(SHADER_API_GLCORE)) || defined(SHADER_API_SWITCH) || defined(SHADER_API_SWITCH2)
